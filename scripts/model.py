...
# class EncoderRNN(nn.Module):
    ...
    def forward(self, input_seqs, input_lengths, hidden=None, input_seqs_char = None):
        ...
        raw_outputs1 = F.relu(self.out1(outputs.view(seq_len * batch_size, -1)))
...
class BahdanauAttnDecoderRNN(nn.Module):
    ...
    def forward(self, di, word_input, last_hidden, encoder_outputs, input_lengths):
        ...
        word_embedded = self.embedding(word_input).view(1, this_batch_size, -1)  
        ...
        final_outputs1 = F.relu(self.out1(input_to_final))
